              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
                ...
                {cards.length < 20 && (
                  <button 
                     ...
                     style={{ padding: '12px 24px', fontSize: '1rem', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '8px', height: '45px' }}
                  >
                     <span className="material-symbols-outlined">add_circle</span> Añadir tarjeta
                  </button>
                )}
              </div>
